...
import { LayoutDashboard, Bot, FileText, Newspaper, BarChart2, Settings, Scan, Wallet, Columns3, GraduationCap, Microscope, Box, Archive } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/closed-bots', label: 'Closed Bots', icon: Archive },
